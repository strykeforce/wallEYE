    ...
    for img in images:
        ...
        if len(corners) > 0:
            ...
            for i in ids:
                ...
                c1 = translationToSolvePnP(pose + wpi.Transform3d(wpi.Translation3d(0, -squareLength / 2, -squareLength / 2), wpi.Rotation3d()))
                c2 = translationToSolvePnP(pose + wpi.Transform3d(wpi.Translation3d(0, squareLength / 2, -squareLength / 2), wpi.Rotation3d()))
                c3 = translationToSolvePnP(pose + wpi.Transform3d(wpi.Translation3d(0, squareLength / 2, squareLength / 2), wpi.Rotation3d()))
                c4 = translationToSolvePnP(pose + wpi.Transform3d(wpi.Translation3d(0, -squareLength / 2, squareLength / 2), wpi.Rotation3d()))
