...
export default function PoseVisualizationList(props) {
    ...
    return (
        <>
            <Button variant="info" onClick={() => { socket.emit("toggle_pose_visualization") }}><i class="bi bi-bar-chart-line-fill"></i>{isRendering ? "Stop Visualizing" : "Start Visualizing"}</Button>
            <br/>           
